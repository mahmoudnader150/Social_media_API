...
public class NotificationWebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        // Enable a simple in-memory message broker with destinations prefixed with /user and /topic
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        // Register the "/notification-ws" endpoint, enabling the SockJS fallback options
